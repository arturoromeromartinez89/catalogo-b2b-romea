...
const simpleAdminTabs = ["inicio", "catalog", "preorders", "clients", "company", "database"];
...
export default function AdminDashboard({ profile, tenantOverride = "", supportMode = false, supportTenantName = "", onExitSupport }) {
  ...
  const simplifiedAdmin = import.meta.env.VITE_SIMPLE_ADMIN === "true";
  const tenantTabs = simplifiedAdmin ? simpleAdminTabs : baseTabs;
  const tabs = superadmin ? ["tenants", ...baseTabs] : [...tenantTabs]; // se extiende abajo con extraTabs

...
const labels = {
  ...
  descripcion: { es: ["Descripcion", "Ej. Anillo de caballero con piedra negra."], en: ["Description", "Ex. Men's ring with black stone."] },
  ...
  linea: { es: ["Linea", "Ej. Dama, Caballero, Infantil."], en: ["Line", "Ex. Women, Men, Kids."] },
